...
function Button({
  ...
  const isDarkButton = variant === 'default' || (className && (className.includes('#2f2f2f') || className.includes('#1a1a1a') || className.includes('bg-white/1') || className.includes('bg-black')));
